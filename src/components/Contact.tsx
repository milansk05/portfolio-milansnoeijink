...
// Lijst met gekende problematische domeinen
...
const ContactFormSkeleton = () => (
  <div className="space-y-4">
    ...
    <div>
      <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-20 animate-pulse mb-1" />
      <div className="h-12 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
    </div>
    <div>
      <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-16 animate-pulse mb-1" />
...
const ContactLoader = () => (
  <div className="flex flex-col items-center justify-center py-12">
    ...
    <div className="flex items-center space-x-2 mt-4">
      {["Formulier", "Validatie", "reCAPTCHA"].map((step, index) => (
        <motion.div
          key={step}
      ...
      >
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
              <div className="bg-card rounded-lg shadow-lg p-6 text-card-foreground">
                <h3 className="text-xl font-bold mb-6 text-accent-foreground border-b pb-2">
                  Stuur een bericht
                </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-medium mb-1 text-accent-foreground"
                    >
                      Naam
                    </label>
                    <input
                      ...
                      className={`w-full px-4 py-2 rounded-md border focus:outline-none focus:ring-2 text-black ${
                        errors.name
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-accent-foreground/80 ml-6">
                      ...
                      <a
                        ...
                        className="text-[#ed7100] hover:underline"
                      >
                        HQ-Online
                      </a>
                      .
                  ...
                  <div className="pt-4 border-t">
                    <p className="text-accent-foreground/80 italic">
                      Ik sta altijd open voor interessante projecten en nieuwe
                      samenwerkingen!
                    </p>
                  </div>
                </div>
